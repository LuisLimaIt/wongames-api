...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/luislimait',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/luisplsoares/',
  }
];
        ...
        <div className="row">
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P>
                Para saber mais sobre minhas experiências profissionais,
                acesse minhas redes sociais =)
              </P>
              <ALink
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/luisplsoares/"
                target="_blank"
              >
